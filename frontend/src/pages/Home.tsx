...
import { Search, Calendar, Users, Bed, Coffee, Wifi, Car, ArrowRight } from 'lucide-react';
...
function Home() {
  ...
  const getData = async () => {
    await axios
      .get(import.meta.env.VITE_BACKEND_URL + '/hotel/getHotel', {
        headers: {
    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        <div
          ...
          style={{
            backgroundImage:
              'url("https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcR4QDgeW-EqignugZkJMMZzi7JS6Uwl0nR86T9F0PRAu3UIoCKkN_SGnC2_f7NcXZRWZb87_fn_h7df09I3HfGu7HmugZiK_Se6mSg3XQ")',
          }}
        >
          <div className="absolute inset-0 bg-black bg-opacity-50"></div>
          <div className="relative container mx-auto px-4 h-full flex flex-col justify-center">
            <h1 className="text-5xl font-bold text-white mb-6">Find Your Perfect Stay</h1>
            <p className="text-xl text-white mb-8 max-w-2xl">
              Discover luxury accommodations at the best prices. Book your dream hotel stay with us
              today.
            </p>
